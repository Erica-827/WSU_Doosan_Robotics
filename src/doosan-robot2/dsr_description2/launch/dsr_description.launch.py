...
#     package="hum_pkg",  # The package with your RobotController
#     executable="r_controller",  # This will execute the r_controller.py file
#     namespace=LaunchConfiguration('name'),
#     output="screen",  # Log output in the terminal
#     parameters=[robot_description]
# )

# return LaunchDescription(ARGUMENTS + [static_tf, robot_state_publisher, joint_state_publisher_gui, rviz_node, robot_controller_node])
